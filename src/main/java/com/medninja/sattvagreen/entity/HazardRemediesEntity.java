...
@Entity
@Table(name = "hazardremedies")
public class HazardRemediesEntity {
    @Id
    ...
    public HazardRemediesEntity(long remid, String remedySource, String disease,String remedy) {
        this.remid = remid;
        this.remedySource = remedySource;
        this.disease = disease;
        this.remedy=remedy;
